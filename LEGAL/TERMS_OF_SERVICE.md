...
## EN
These terms govern your use of paid or hosted services related to this project.

1. Account
- You are responsible for account credentials and activities.

2. Acceptable Use
- No abuse, illegal use, service disruption, malware distribution, or infringement.

3. Service Availability
- Service may change, suspend, or discontinue with reasonable notice where possible.

4. Fees
- This project is completely free. There are no paid plans or fees.
...
7. Liability
- To the maximum extent allowed by law, liability is limited as specified in commercial agreement or applicable policy.
...
2. 可接受使用
- 禁止滥用、违法使用、破坏服务、传播恶意软件或侵权。

3. 服务可用性
- 在可行情况下，我们会提前通知服务变更、暂停或停止。
