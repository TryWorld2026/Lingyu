...
const nativeDllPath = path.join(__dirname, '..', 'src', 'bin', 'Release', TFM, 'win-x64', 'native', 'LingyuScreenshotHelper.dll');
...
describe.skipIf(!isWindows || !hasNativeDll)('@lingyu/windows-screenshot-helper', () => {
