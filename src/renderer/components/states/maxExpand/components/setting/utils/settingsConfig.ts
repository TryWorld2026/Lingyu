...
export const SEARCHABLE_SETTINGS: SearchableSettingItem[] = [
  ...
  // ── 网络配置 > 数据中心 ──
  { label: '静态资源节点', desc: '用于下载更新与静态资源，默认使用 Cloudflare R2。', labelKey: 'settings.network.staticAssetNode.title', descKey: 'settings.network.staticAssetNode.hint', tab: 'network', networkPage: 'data-center' },
